 ...
 */
public class TopBeats extends BaseAdapter {
    Fragment selectedFragment = null;
    Context context;
    public static List<Datum> FeaturedList;

    private UtilInterface mCallback;

//    public interface UtilInterface {
//        void Refresh(String one);
//    }

    public TopBeats(Context c, List<Datum> FeaturedList,UtilInterface mCallback) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        TopBeats.Holder holder = null;
        if (rowView == null) {
            LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            rowView = inflater.inflate(R.layout.featured_beats_single_row, null);
            holder = new TopBeats.Holder(rowView);
            rowView.setTag(holder);
        } else {

            holder = (TopBeats.Holder) rowView.getTag();
        }
