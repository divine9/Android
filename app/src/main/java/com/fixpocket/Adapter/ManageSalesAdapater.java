 ...
 */
public class ManageSalesAdapater extends ArrayAdapter {
    ...
    public ManageSalesAdapater(Context c, String[] Name, int[] Img) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ManageSalesAdapater.Holder holder = null;
        if(rowView==null){
            LayoutInflater inflater = (LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            rowView = inflater.inflate(R.layout.manage_sales_single_row, null);
            holder = new ManageSalesAdapater.Holder(rowView);
            rowView.setTag(holder);
        }
        else {

            holder = (ManageSalesAdapater.Holder) rowView.getTag();
        }
