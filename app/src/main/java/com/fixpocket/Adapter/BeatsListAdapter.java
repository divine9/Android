 ...
 */
public class BeatsListAdapter extends BaseAdapter {
    Fragment selectedFragment = null;
    Context context;
    public static List<Datum> FeaturedList;


    public BeatsListAdapter(Context c, List<Datum> FeaturedList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        BeatsListAdapter.Holder holder = null;
        if (rowView == null) {
            LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            rowView = inflater.inflate(R.layout.featured_beats_single_row, null);
            holder = new BeatsListAdapter.Holder(rowView);
            rowView.setTag(holder);
        } else {

            holder = (BeatsListAdapter.Holder) rowView.getTag();
        }
